			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Adventure</a></li>
					<li><a href="#furniture" data-toggle="tab">Novel</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
<?php
$ret=mysqli_query($con,"select * from products where category=7 and subCategory=6");
while ($row=mysqli_fetch_array($ret)) 
{
?>
